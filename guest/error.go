...
var (
	APINotAvailablePatterns = []*regexp.Regexp{
		...
		// Also see the following match example.
		...
		// connections to guest clusters while the guest API is not fully up. Also
		// see the following match example.
		...
		// certificates returned while the guest API is not fully up. Also see the
		// following match example.
